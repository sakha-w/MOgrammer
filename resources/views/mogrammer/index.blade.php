...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="{{ asset('assets/img/gallery/design.png')}}" alt="courses" />
                <div class="card-body">
      ...
      <section>
        <div class="bg-holder" style="background-image:url({{ asset('assets/img/gallery/funfacts-2-bg.png')}} );background-position:center;background-size:cover;"> 
        </div>
        <!--/.bg-holder-->
